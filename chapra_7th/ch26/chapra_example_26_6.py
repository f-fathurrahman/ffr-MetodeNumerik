...
# Initial data, required for Adams4th algorithm
yim1 = exact_sol(x0-h)
yim2 = exact_sol(x0-2*h)
yim3 = exact_sol(x0-3*h)
x[1] = x[0] + h
y[1] = ode_Adams4th_1step(deriv, x[0], y[0], yim1, yim2, yim3, h)
...
yim1 = y[0]
x[2] = x[1] + h
y[2] = ode_Adams4th_1step(deriv, x[1], y[1], yim1, yim2, yim3, h)
...
yim1 = y[1]
x[3] = x[2] + h
y[3] = ode_Adams4th_1step(deriv, x[2], y[2], yim1, yim2, yim3, h)
...
yim1 = y[2]
x[4] = x[3] + h
y[4] = ode_Adams4th_1step(deriv, x[3], y[3], yim1, yim2, yim3, h)
