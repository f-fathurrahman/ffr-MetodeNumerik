function [P, t, I] = circle_refine(R, P, t, I, error, percentage, par, method)
%   SYNTAX
%   [P, t, I] = circle_refine(R, P, t, I, error, percentage, par, method)
%   DESCRIPTION
%   This function refines a mesh for a base circle (or other geometry)
...
%   Nazarian, Wiley, New York, 2015, 1st ed.
    ...
    nodesb1 = R*nodesb./repmat(sqrt(sum(nodesb.*nodesb, 2)), 1, 2); %   Only valid for the circle
