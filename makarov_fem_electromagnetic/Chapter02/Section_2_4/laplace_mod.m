function [Pnew, t] = laplace_mod(P, I, type)
%   SYNTAX 
%   [Pnew, t] = laplace_mod(P, I, type)
%   DESCRIPTION 
...
%   Pnew - array of nodes
%   t - triangulation
%   Modification: area weighting is not used for types 3, 4
%  
...
%   Nazarian, Wiley, New York, 2015, 1st ed.
    ...
    A   = ones(size(A));    %   Modification is here
