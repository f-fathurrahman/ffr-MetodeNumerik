clear all;
%   Create a uniform mesh for a base sphere of radius R with approximately Tr triangles
...
%   Distance function
fd = inline('sqrt(sum(P.^2, 2))-R', 'P', 'R');
...
while 1
    ...
    if max(sqrt(sum((P-Pold).^2,2))/h0)>ttol        %   Any large movement?
        ...
        DT  = delaunayTriangulation(P);             %   3D Delaunay triangulation
