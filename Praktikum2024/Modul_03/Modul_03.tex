...
{\centering
\includegraphics[width=0.8\textwidth]{images_priv/Chapra_Fig_9_4.png}
\par}
...
Jika Anda tidak ingin menampilkan langkah-langkah yang diambil, parameter
\pyinline{verbose} diatur menjadi \pyinline{False} (ini adalah nilai \textit{default}
sehingga Anda juga dapat memanggil \pyinline{linsolve_gauss_elim} tanpa parameter ini).
Parameter \pyinline{verbose} dimaksudkan agar kita dapat melihat
...
\begin{figure}
{\centering
\includegraphics[width=\textwidth]{images_priv/Chapra_Fig_10_2.png}
\par}
