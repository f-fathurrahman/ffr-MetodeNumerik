...
! Steady State (iterative) approach to solving a PDE
! Example 5.3.
...
! Open output file
    OPEN(unit=10, file="Example5_3_steady.out", status = "unknown")
    OPEN(unit=20, file="Example5_3_steady.rsl", status = "unknown")
