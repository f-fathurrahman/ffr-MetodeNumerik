...
! Declaration of variables
    IMPLICIT NONE
    INTEGER(4), PARAMETER :: n_nodes = 21, max_times = 20
    INTEGER(4) :: itimes,i
...
! Open output file
    OPEN(unit=10, file="Example5_4_Im.out", status = "unknown")
    OPEN(unit=20, file="Example5_4_Im_point.out", status = "unknown")
