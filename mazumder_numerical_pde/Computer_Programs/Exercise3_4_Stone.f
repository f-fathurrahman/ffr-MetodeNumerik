...
! using the finite-difference method and Stone's Strongly Implicit method
! Exercise 3.4(d)
...
! Open output file
    OPEN(unit=10, file="Exercise3_4_Stone.out", status = "unknown")
    OPEN(unit=20, file="Exercise3_4_Stone.rsl", status = "unknown")
