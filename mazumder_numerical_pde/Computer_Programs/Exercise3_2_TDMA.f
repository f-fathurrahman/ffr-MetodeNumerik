...
! ADI Method with Tri-Diagonal Matrix (TDMA) Solver
! Exercise 3.2
...
! Open output file
    OPEN(unit=10, file="Exercise3_2_TDMA.out", status = "unknown")
    OPEN(unit=20, file="Exercise3_2_TDMA.rsl", status = "unknown")
