...
! using the finite-difference method and Line-by-Line (ADI) iterations
! Exercise 3.4(c)
...
! Declaration of variables
    IMPLICIT NONE
    INTEGER(4), PARAMETER :: n = 161, m = 161
...
! Open output file
    OPEN(unit=10, file="Exercise3_4_ADI.out", status = "unknown")
    OPEN(unit=20, file="Exercise3_4_ADI.rsl", status = "unknown")
