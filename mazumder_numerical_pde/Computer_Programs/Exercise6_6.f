! This is a code for solving the 2D Poisson equation using the FVM
...
! Declaration of variables
    IMPLICIT NONE
    INTEGER(4), PARAMETER :: nc = 100, mc = 10, max_iter = 100000
    INTEGER(4) :: i,j,iter
...
! Open output file
    OPEN(unit=10, file="Exercise6_6.out", status = "unknown")
    OPEN(unit=20, file="Exercise6_6.rsl", status = "unknown")
