...
! using the finite-difference method and Stone's method.
...
! Open output file
    OPEN(unit=10, file="Exercise3_6_Stone.out", status = "unknown")
    OPEN(unit=20, file="Exercise3_6_Stone.rsl", status = "unknown")
