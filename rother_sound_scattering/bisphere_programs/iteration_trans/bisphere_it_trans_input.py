#            Program "bisphere_it_trans_input.py"
#
...
print('           ... wave scattering on arbitrarily oriented ---')
print('                          ... bispheres! ---')
print()
print()

import os
os.system("del input_data_bisphere_it_trans.txt")
os.system("type nul > input_data_bisphere_it_trans.txt")
fobj = open("input_data_bisphere_it_trans.txt", "w")
