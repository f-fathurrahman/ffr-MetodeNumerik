...
print()
print()
print(" --- Plane wave scattering on combinations of acoustically soft, ...")
print("   ... hard, or penetrable spheres arbitrarily oriented in the ...")
print("            ... laboratory frame (rotation and shift!). ---")
print()
print()

os.system("del input_data_bisphere_it.txt")
os.system("type nul > input_data_bisphere_it.txt")
fobj = open("input_data_bisphere_it.txt", "w")

LS = int(input(' 0. iteration (0), 1. iteratio (1), or 2. iteration (2)? '))
print()
...
theta_p = float(input('Eulerian angle theta_p [Grad]: '))
print()
