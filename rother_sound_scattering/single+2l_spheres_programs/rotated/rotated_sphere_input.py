#            Program "rotated_sphere_input.py"
#

print()
print('     --- Input scattering configuration for acoustic plane ...')
print('            ... wave scattering on a rotated sphere! ---')
print()

import os
os.system("del input_data_rotated_sphere.txt")
os.system("type nul > input_data_rotated_sphere.txt")
fobj = open("input_data_rotated_sphere.txt", "w")
