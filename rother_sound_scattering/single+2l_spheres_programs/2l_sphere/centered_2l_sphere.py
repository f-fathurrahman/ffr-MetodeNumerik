#            Program "centered_2l_sphere.py"
#
# This program calculates the plane wave scattering behaviour of a 
# two-layer sphere with an acoustically soft or hard core and an 
# acoustically penetrable shell. Note, that the density of the 
# material "rho_0" outside the spheres is always given by 1.
#
...
fobj = open("input_data_centered_2l_sphere.txt", "r")
...
#  wave number "k" (outer space) and total radius of the 2-layer sphere:
...
if para == 'sp':
    tm = bas.tm_sp(ncut, beta_b, a, b, k0, k_p_k, rho_p)
else:
    tm = bas.tm_hp(ncut, beta_b, a, b, k0, k_p_k, rho_p)
...
theta = scp.linspace(0.0, 180.0, 361)
...
os.system("del dscross_centered_2l_sphere.txt")
os.system("type nul > dscross_centered_2l_sphere.txt")
fobj1 = open("dscross_centered_2l_sphere.txt", "w")
nl = "\n"
for i in range(0, 361):
    a1 = str(theta[i])
    a2 = " = "
