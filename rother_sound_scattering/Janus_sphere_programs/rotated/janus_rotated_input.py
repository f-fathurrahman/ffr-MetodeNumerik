#            Program "janus_rotated_input.py"
...
import os
os.system("del input_data_janus_rotated.txt")
os.system("type nul > input_data_janus_rotated.txt")
fobj = open("input_data_janus_rotated.txt", "w")
...
lcut = int(input("truncation parameter ...  lcut <= ncut: "))
print()
