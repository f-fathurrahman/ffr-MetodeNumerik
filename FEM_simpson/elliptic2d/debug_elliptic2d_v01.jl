...
for iel in 1:Nelements # loop over elements
    ...
    for k in 1:NintegPoints
        ...
        # accumulate?
        U[num] = U[num] .+ u # x-vel at integration point
        V[num] = V[num] .+ v # y-vel at integration point
    end
end
