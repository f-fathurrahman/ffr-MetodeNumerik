...
boundary.air_buffer_number_of_cells_xp = 6;

boundary.type_xn = 'pec';
boundary.air_buffer_number_of_cells_xn = 6;

boundary.type_yp = 'pec';
boundary.air_buffer_number_of_cells_yp = 6;

boundary.type_yn = 'pec';
boundary.air_buffer_number_of_cells_yn = 6;

boundary.type_zp = 'pec';
boundary.air_buffer_number_of_cells_zp = 6;

boundary.type_zn = 'pec';
boundary.air_buffer_number_of_cells_zn = 6;
