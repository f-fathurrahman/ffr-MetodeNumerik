...
% the platform on which the calculations will be performed
% 1: matlab on cpu, 2: C executable on cpu, 3: C executable on gpu 
computation_platform  = 3; 
...
boundary.air_buffer_number_of_cells_xn = 100;
boundary.cpml_number_of_cells_xn = 8;

boundary.type_xp = 'cpml';
boundary.air_buffer_number_of_cells_xp = 100;
boundary.cpml_number_of_cells_xp = 8;

boundary.type_yn = 'cpml';
boundary.air_buffer_number_of_cells_yn = 100;
boundary.cpml_number_of_cells_yn = 8;

boundary.type_yp = 'cpml';
boundary.air_buffer_number_of_cells_yp = 100;
