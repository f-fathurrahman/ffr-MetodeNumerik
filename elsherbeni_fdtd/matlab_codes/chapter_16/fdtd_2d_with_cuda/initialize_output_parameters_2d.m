...
number_of_sampled_transient_H_planes=size(sampled_transient_H_planes,2);
...
if computation_platform == 1
    ...
    % initialize sampled transient magnetic field 
    for ind=1:number_of_sampled_transient_H_planes  
        sampled_transient_H_planes(ind).figure = figure;
    end
end
