...
mu_r_x(2:nx,1:ny,1:nz) = 2 * (t_mu_r(material_3d_space(2:nx,1:ny,1:nz)) ...
...
mu_r_y(1:nx,2:ny,1:nz) = 2 * (t_mu_r(material_3d_space(1:nx,2:ny,1:nz)) ...
...
mu_r_z(1:nx,1:ny,2:nz) = 2 * (t_mu_r(material_3d_space(1:nx,1:ny,2:nz)) ...
...
sigma_m_x(2:nx,1:ny,1:nz) = 2 * (t_sigma_m(material_3d_space(2:nx,1:ny,1:nz)) ...
...
sigma_m_y(1:nx,2:ny,1:nz) = 2 * (t_sigma_m(material_3d_space(1:nx,2:ny,1:nz)) ...
...
sigma_m_z(1:nx,1:ny,2:nz) = 2 * (t_sigma_m(material_3d_space(1:nx,1:ny,2:nz)) ...
