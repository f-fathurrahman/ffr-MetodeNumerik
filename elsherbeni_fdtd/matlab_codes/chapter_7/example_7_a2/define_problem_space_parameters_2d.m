...
boundary.air_buffer_number_of_cells_xn = 600;
boundary.pml_number_of_cells_xn = 5;

boundary.type_xp = 'pec';
boundary.air_buffer_number_of_cells_xp = 600;
boundary.pml_number_of_cells_xp = 5;

boundary.type_yn = 'pec';
boundary.air_buffer_number_of_cells_yn = 600;
boundary.pml_number_of_cells_yn = 5;

boundary.type_yp = 'pec';
boundary.air_buffer_number_of_cells_yp = 600;
boundary.pml_number_of_cells_yp = 5;
