...
boundary.air_buffer_number_of_cells_xn = 30;
boundary.pml_number_of_cells_xn = 10;

boundary.type_xp = 'pml';
boundary.air_buffer_number_of_cells_xp = 80;
boundary.pml_number_of_cells_xp = 10;

boundary.type_yn = 'pml';
boundary.air_buffer_number_of_cells_yn = 30;
boundary.pml_number_of_cells_yn = 10;

boundary.type_yp = 'pml';
boundary.air_buffer_number_of_cells_yp = 30;
boundary.pml_number_of_cells_yp = 10;
