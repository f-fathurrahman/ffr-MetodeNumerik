...
% Source wavelet  s rho_0 Q = 1

global nDIM;  nDIM = 2;                     % set dimension of space
         
input.c_0     = 1500;                       % wave speed in embedding
input.c_sct   = 1500;                       % wave speed in scatterer
input.rho_0   = 3000;                       % mass density in embedding
...
% add input data to structure array 'input'
  ...
  % Kirchhoff type of approximation in object operators 
  input.Kirchhoff = 0; % value = 0: no approximation
                       % value = 1: approximation in adjoint
                       % value = 2: plus approximation in forward operator
