...
% USAGE: Can be used only for the x-direction, 
%   for the y-direction, additional conditions must
%   be taken into account, see p. ????
% CAVEAT: If at the inital timestep, the particles
%   have been initialiyed in unfavorable positions 
%   (particles with lower index to the right of particles with
...
% |--- i---|       lo_bound_x(i)< up_bound_x(j) & lo_bound_x(j)<up_bound_x(i)         
%   |--- j---|             is the same as
%      |--- i---|  lo_bond(j) < up_bound_x(i) & lo_bound_x(i)<up_bound_xXF(j)
