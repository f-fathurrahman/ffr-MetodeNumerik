#=
From: https://github.com/JuliaApproximation/FastGaussQuadrature.jl/blob/master/src/gausslegendre.jl
=#
...
@inline function gausslegendre(n::Integer)
    ...
    elseif n ≤ 60
        ...
        return _my_GLQ_rec(n)
    else
        # USE ASYMPTOTIC EXPANSIONS:
        return _my_GLQ_asy(n)
    end
end

function _my_GLQ_asy(n)
    ...
    a = besselZeroRoots(m)
    rmul!(a, 1 / (n + 0.5))
    x = _my_GLQ_legpts_nodes(n, a)
    w = _my_GLQ_legpts_weights(n, m, a)
...
function _my_GLQ_legpts_nodes(n, a)
...
function _my_GLQ_legpts_weights(n, m, a)
