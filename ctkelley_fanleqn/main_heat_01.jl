using LinearAlgebra: SymTridiagonal, Symmetric, ldlt, rmul!
using LinearAlgebra: BandedMatrix, axpy!, mul!, norm, ldiv!, cond, qr!, axpby!
...
include("AA_Tools.jl")
include("FunctionJacobianEvals.jl")
include("ManageStats.jl")
include("kl_gmres.jl")
include("kl_bicgstab.jl")
include("ortho1.jl")
include("IterationInit.jl")
include("NewtonKrylov_Tools.jl")
include("ErrorTest.jl")
include("nsoli.jl")
include("armijo.jl")
include("aasol.jl")
include("CR_Heat.jl")
