...
%
% It solves 1-D Poisson's equation with "quadratic" elements and 
...
M = 3;         % number of quadratic elements
...
Ae = [7 -8 1; -8 16 -8; 1 -8 7]*eps/(3*le); % element matrix
...
for e = 1:M  % loop over all elements
    be = [1;4;1]*le*rhov(e)/6; % element b-vector
