...
%
% It solves 1-D generalized Laplace’s equation with "cubic" elements 
...
for e = 1:M  % loop over all elements
    be = [0;0;0;0]; % zero element b-vector    
    %be = [1;3;3;1]*le*rhov(e)/8; % element b-vector (enable if rhov is nonzero)
    Ae = [148 -189 54 -13; -189 432 -297 54; 54 -297 432 -189; ...
         -13 54 -189 148]*eps(e)/(40*le); % element matrix
