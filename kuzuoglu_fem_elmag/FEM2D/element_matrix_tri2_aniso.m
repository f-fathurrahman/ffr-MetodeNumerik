function [Ae, be, areae] = element_matrix_tri2_aniso(e, x, y, conn, pxxe, pyye, pxye, pyxe, qe, fe)
...
% pxxe : pxx value of the e-th element
% pyye : pyy value of the e-th element
% pxye : pxy value of the e-th element
% pyxe : pyx value of the e-th element
...
for i = 1:Ne
    for j = i:Ne
        Ae1(i,j)=(((Jinv11.*delNijdelpsi(i)+Jinv12.*delNijdelnu(i))*pe(1,1) +...
                   (Jinv21.*delNijdelpsi(i)+Jinv22.*delNijdelnu(i))*pe(1,2)).* ...
                   (Jinv11.*delNijdelpsi(j)+Jinv12.*delNijdelnu(j))+ ...
                   ((Jinv11.*delNijdelpsi(i)+Jinv12.*delNijdelnu(i))*pe(2,1) + ...
                   (Jinv21.*delNijdelpsi(i)+Jinv22.*delNijdelnu(i))*pe(2,2)).* ...
