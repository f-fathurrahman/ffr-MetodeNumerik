...
% Mesh Generation
%****************
Lx = 0.05; % m, length of the computational domain along x axis
Ly = 0.05; % m, length of the computational domain along y axis

dx = 0.02; % m, length of the capacitor plate along x axis
dy = 0.01; % m, length of the dielectric region inside capacitor along y axis
