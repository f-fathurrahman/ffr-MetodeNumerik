%% Name: FEM2D_periodic_grating.m 
% 2D Scattering from a PEC Periodic Grating (Sec. 5.6.5)
%
...
% % Trapezoid grating
% svx = [0 0.5 1 2 2.5 3]*lambda0;   % Grating Vertex Coordinates (x)
% svy = [0 0 1.5 1.5 0 0]*lambda0;   % Grating Vertex Coordinates (y)

% % Triangular grating
% svx = [0 0.5 1.5 2.5 3]*lambda0;   % Grating Vertex Coordinates (x)
% svy = [0 0 1.5 0 0]*lambda0;       % Grating Vertex Coordinates (y)
% 
% Rectangular grating
svx = [0 1 1 2 2 3]*lambda0;       % Grating Vertex Coordinates (x)
svy = [0 0 1.5 1.5 0 0]*lambda0;   % Grating Vertex Coordinates (y)

obj = struct('svx', svx, 'svy', svy,'delh',delh);    
...
set(gcf, 'Color', [1 1 1]);
hold on
fill(x(scatb_node), y(scatb_node),'w','linewidth',2)
