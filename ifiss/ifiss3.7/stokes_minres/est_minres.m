...
%   IFISS function: DJS; 2 January 2011; 17 August 2020
...
etoc=cputime-tstart;
if i==maxit,
fprintf('Oops .. maximum number of iterations reached\n')
else
fprintf('Bingo!\n')
fprintf('\nconvergence in %3i iterations\n',i)
end
fprintf('  %9.4e seconds\n',etoc)
fprintf('infsup constant is %9.4e \n\n',sqrt(infsup(i)))
info=[infsup(i),lambda(i)];  %% returns eigenvalue estimates via info
if nout,
   fprintf('Eigenvalue convergence')
   fprintf('\n    k     infsup     lambda \n')
      for its=4:i+1,
