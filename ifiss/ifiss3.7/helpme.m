...
% Copyright (c) 2023 D.J. Silvester, H.C. Elman, A. Ramage (see readme.m)

fprintf(' \n');
fprintf(' IFISS\n')
fprintf('Copyright (c) 2023 by D.J. Silvester, H.C. Elman and A. Ramage (see readme.m)\n')
%fprintf(' \n');
...
elseif hlp==3, gohome; cd stokes_flow; helpme_stokes;  pause, helpme_stopping; helpme_twofieldpressure
