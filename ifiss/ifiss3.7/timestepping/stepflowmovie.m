%STEPFLOWMOVIE step flow solution animation
...
for i=1:krestart
   ...
   sstep_unsteadyflowref(qmethod,mv,U,soltime,A,By,Bx,G,xy,xyp,x,y,bound,i,...
                      krestart,vfreq,xref,uvid,upvid,uxmax,uxmin,symm);
