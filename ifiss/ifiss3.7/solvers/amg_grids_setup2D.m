function [grid_data] = amg_grids_setup2D(A, i_method, max_levels)
%AMG_GRIDS_SETUP2D efficiently performs algebraic multigrid setup phase
%			and returns a structure grid_data for use by amg_solver
%
% For use with AMG_V_CYCLE
%
% amg_grids_setup2D(A, i_method, max_levels)
%
