...
% set structure for preconditioner
   ...
   %  compute new MG data or reload existing data?
      ...
      if compute_mg==2
         ...
         amg_gridF = amg_grids_setup2D(Jbc);
         fprintf('\n')
      ...
      elseif precon==3, %%% AMG iterated LSC 
         ...
         else amg_gridA = amg_grids_setup2D(Bbc*(Gdiag\Bbc'));
         end
         ...
         amg_gridFt = amg_grids_setup2D(Tbc);
      ...
      elseif precon==9,      %%% AMG iterated PCD*
         ...
         Gdiag=spdiags(diag(Qv),0,nuv,nuv);
         amg_gridA = amg_grids_setup2D(Bbc*(Gdiag\Bbc'));
